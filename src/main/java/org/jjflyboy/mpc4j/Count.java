...
public class Count extends AbstractCommand<Count.Response> {
    ...
    private final org.jjflyboy.mpc4j.Tag group;
    /**
     ...
     */
    public Count(Tag tag, String needle, org.jjflyboy.mpc4j.Tag group) {
     ...
     * @param group optional value to group results by, null if none.
     */
    public Count(Filter[] filters, org.jjflyboy.mpc4j.Tag group) {
     ...
     * @param filters array of TYPE-WHAT filter pairs.
     */
    public Count(org.jjflyboy.mpc4j.Tag group, Filter... filters) {
        this(filters, group);
    }
    ...
    public class Response extends SimpleResponse {
        ...
        public class Group extends ResponseContent {
            ...
            public Optional<String> getTag(org.jjflyboy.mpc4j.Tag tag) {
